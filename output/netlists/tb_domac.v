...
module tb_domac;
    ...
    wire out_pp_0, out_pp_1, out_pp_8, out_pp_16, out_pp_63, comp_0_S, comp_1_S, comp_2_S, comp_5_S, comp_8_S, comp_9_S, comp_14_S, comp_19_S, comp_20_S, comp_25_S, comp_26_S, comp_30_S, comp_31_S, comp_34_S, comp_35_S, comp_37_S, comp_38_S, comp_39_S, comp_40_S, comp_41_S, comp_2_CO, comp_9_CO, comp_40_CO, comp_41_CO;
    ...
    initial begin
        ...
        for (i = 0; i < 1000; i = i + 1) begin
            ...
            actual_weight = 0 + (out_pp_0 * (64'h1 << 0)) + (out_pp_1 * (64'h1 << 1)) + (out_pp_8 * (64'h1 << 1)) + (out_pp_16 * (64'h1 << 2)) + (out_pp_63 * (64'h1 << 14)) + (comp_0_S * (64'h1 << 2)) + (comp_1_S * (64'h1 << 3)) + (comp_2_S * (64'h1 << 3)) + (comp_5_S * (64'h1 << 4)) + (comp_8_S * (64'h1 << 5)) + (comp_9_S * (64'h1 << 5)) + (comp_14_S * (64'h1 << 6)) + (comp_19_S * (64'h1 << 7)) + (comp_20_S * (64'h1 << 7)) + (comp_25_S * (64'h1 << 8)) + (comp_26_S * (64'h1 << 8)) + (comp_30_S * (64'h1 << 9)) + (comp_31_S * (64'h1 << 9)) + (comp_34_S * (64'h1 << 10)) + (comp_35_S * (64'h1 << 10)) + (comp_37_S * (64'h1 << 11)) + (comp_38_S * (64'h1 << 11)) + (comp_39_S * (64'h1 << 12)) + (comp_40_S * (64'h1 << 12)) + (comp_41_S * (64'h1 << 13)) + (comp_2_CO * (64'h1 << 4)) + (comp_9_CO * (64'h1 << 6)) + (comp_40_CO * (64'h1 << 13)) + (comp_41_CO * (64'h1 << 14));
