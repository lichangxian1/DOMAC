...
module tb_domac;
    ...
    wire out_pp_0, out_pp_1, out_pp_4, out_pp_6, out_pp_12, out_pp_13, out_pp_34, out_pp_35, comp_0_S, comp_2_S, comp_5_S, comp_8_S, comp_9_S, comp_12_S, comp_13_S, comp_15_S, comp_16_S, comp_17_S, comp_18_S, comp_19_S, comp_19_CO;
    ...
    initial begin
        ...
        for (i = 0; i < 1000; i = i + 1) begin
            ...
            expected_weight = 0 + (pp_in_0 * (64'h1 << 0)) + (pp_in_1 * (64'h1 << 1)) + (pp_in_2 * (64'h1 << 2)) + (pp_in_3 * (64'h1 << 3)) + (pp_in_4 * (64'h1 << 4)) + (pp_in_5 * (64'h1 << 5)) + (pp_in_6 * (64'h1 << 1)) + (pp_in_7 * (64'h1 << 2)) + (pp_in_8 * (64'h1 << 3)) + (pp_in_9 * (64'h1 << 4)) + (pp_in_10 * (64'h1 << 5)) + (pp_in_11 * (64'h1 << 6)) + (pp_in_12 * (64'h1 << 2)) + (pp_in_13 * (64'h1 << 3)) + (pp_in_14 * (64'h1 << 4)) + (pp_in_15 * (64'h1 << 5)) + (pp_in_16 * (64'h1 << 6)) + (pp_in_17 * (64'h1 << 7)) + (pp_in_18 * (64'h1 << 3)) + (pp_in_19 * (64'h1 << 4)) + (pp_in_20 * (64'h1 << 5)) + (pp_in_21 * (64'h1 << 6)) + (pp_in_22 * (64'h1 << 7)) + (pp_in_23 * (64'h1 << 8)) + (pp_in_24 * (64'h1 << 4)) + (pp_in_25 * (64'h1 << 5)) + (pp_in_26 * (64'h1 << 6)) + (pp_in_27 * (64'h1 << 7)) + (pp_in_28 * (64'h1 << 8)) + (pp_in_29 * (64'h1 << 9)) + (pp_in_30 * (64'h1 << 5)) + (pp_in_31 * (64'h1 << 6)) + (pp_in_32 * (64'h1 << 7)) + (pp_in_33 * (64'h1 << 8)) + (pp_in_34 * (64'h1 << 9)) + (pp_in_35 * (64'h1 << 10));
            actual_weight = 0 + (out_pp_0 * (64'h1 << 0)) + (out_pp_1 * (64'h1 << 1)) + (out_pp_4 * (64'h1 << 4)) + (out_pp_6 * (64'h1 << 1)) + (out_pp_12 * (64'h1 << 2)) + (out_pp_13 * (64'h1 << 3)) + (out_pp_34 * (64'h1 << 9)) + (out_pp_35 * (64'h1 << 10)) + (comp_0_S * (64'h1 << 2)) + (comp_2_S * (64'h1 << 3)) + (comp_5_S * (64'h1 << 4)) + (comp_8_S * (64'h1 << 5)) + (comp_9_S * (64'h1 << 5)) + (comp_12_S * (64'h1 << 6)) + (comp_13_S * (64'h1 << 6)) + (comp_15_S * (64'h1 << 7)) + (comp_16_S * (64'h1 << 7)) + (comp_17_S * (64'h1 << 8)) + (comp_18_S * (64'h1 << 8)) + (comp_19_S * (64'h1 << 9)) + (comp_19_CO * (64'h1 << 10));
